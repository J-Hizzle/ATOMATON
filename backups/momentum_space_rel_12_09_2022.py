...
if __name__ == '__main__':
    ...
    sum_vals = np.asarray(sum_vals)

    comparison = calc_momentum_distribution_function(1, 0, 1, p_grid)

    plt.plot(p_grid, sum_vals, label='rel')
    plt.plot(p_grid, comparison, label='nr')
