...
figname = 'First_few_radial_position_functions_nocap'
...
fig.supylabel(r'$P_{n, l}(r)/\sqrt{Z}\hspace{5mm} (a.u.)$', fontsize=25)
fig.supxlabel('$Zr \hspace{5mm} (a.u.)$', fontsize=25)
